  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Your One-Stop Destination for Hassle-Free Access to Essential Building Equipment Across Multiple Outlets."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental - Your One-Stop Destination for Hassle-Free Access to Essential Building Equipment Across Multiple Outlets.`}
            </Text>
            <Box
